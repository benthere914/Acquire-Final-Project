...
def add_item():
    ...
    if (body['category'] != '' and isinstance(body['category'], dict) and 'value' in body['category']):
        good_category = True
    if (body['condition'] != '' and isinstance(body['condition'], dict) and 'value' in body['condition']):
        good_condition = True
    ...
    if not good_condition:
        output['condition'] = ' - Must celect a condition'
    if not good_category:
        output['category'] = ' - Must select a category'
